...
The third property becomes painful at short lengths. Very short texts — under roughly 50 tokens, the genuinely hard case being a single tweet or brief paragraph — produce detection results that are statistically underpowered, with too few tokens to establish significance at a useful threshold. With appropriate γ and δ parameters the scheme is reliable at 25–50 tokens for longer passages; individual sentence attribution remains difficult. The technique is designed for bulk analysis of long-form documents.
