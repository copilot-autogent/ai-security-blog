...
**Pre-established verification protocols with shared secrets.** The most robust defense against voice and video impersonation is a verification code or phrase agreed upon through a separate, established channel before any high-stakes transaction. If the CFO's policy is to always use a rotating code word when authorizing large transfers, cloning their voice or video doesn't help the attacker. This requires organizational policy and consistent enforcement.
